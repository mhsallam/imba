<template>
  <div class="app-container">
    ...
    <div :key="key" style="margin-top:30px;">
      ...
      <div>
        <span v-permission="['ROLE_EDIT']" class="permission-alert">
          Only
          <el-tag class="permission-tag" size="small">editor</el-tag> can see this
        </span>
        <el-tag v-permission="['ROLE_EDIT']" class="permission-sourceCode" type="info">
    ...
    <div :key="'checkPermission'+key" style="margin-top:60px;">
      ...
      <el-tabs type="border-card" style="width:550px;">
        ...
        <el-tab-pane v-if="checkPermission(['ROLE_EDIT'])" label="Editor">
          Editor can see this
          <el-tag class="permission-sourceCode" type="info">
        ...
        <el-tab-pane v-if="checkPermission(['ROLE_ADMIN', 'ROLE_USER'])" label="Admin-OR-Editor">
